...
from electrum_commercium.util import PrintError, UserCancelled
from electrum_commercium.keystore import bip39_normalize_passphrase
from electrum_commercium.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        ...
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the commercium coins in the wallet.").format(self.device)
        else:
...
class TrezorClientBase(GuiMixin, PrintError):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("cpwallet-cmm pinging device")
            assert res == "cpwallet-cmm pinging device"

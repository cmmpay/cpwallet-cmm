...
from electrum_commercium.util import bfh, bh2u
from electrum_commercium.bitcoin import (b58_address_to_hash160, xpub_from_pubkey,
...
from electrum_commercium.transaction import deserialize, Transaction
from electrum_commercium.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
from electrum_commercium.base_wizard import ScriptTypeNotSupported
...
class KeepKeyCompatiblePlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "commerciumTestnet" if constants.net.TESTNET else "commercium"

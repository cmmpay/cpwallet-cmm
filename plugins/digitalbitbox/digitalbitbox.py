...
try:
    ...
    from electrum_commercium.bitcoin import TYPE_ADDRESS, push_script, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_commercium.bitcoin import serialize_xpub, deserialize_xpub
    ...
    from electrum_commercium.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_commercium.util import print_error, to_string, UserCancelled
    from electrum_commercium.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
...
class DigitalBitbox_Client():
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("cpwallet-cmm-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
        msg = ('{"seed":{"source": "create", "key": "%s", "filename": "%s", "entropy": "%s"}}' % (key, filename, 'Digital Bitbox cpwallet-cmm Plugin')).encode('utf8')

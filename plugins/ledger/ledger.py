...
from electrum_commercium.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
                                   b58_address_to_hash160,
                                   hash160_to_b58_address)
from electrum_commercium.i18n import _
from electrum_commercium.plugins import BasePlugin
from electrum_commercium.keystore import Hardware_KeyStore
from electrum_commercium.transaction import Transaction
from ..hw_wallet import HW_PluginBase
from electrum_commercium.util import print_error, is_verbose, bfh, bh2u, versiontuple
...
try:
    ...
    from .btchip_commercium import btchip_commercium, commerciumTransaction
...
class Ledger_Client():
    def __init__(self, hidDevice):
        self.dongleObject = btchip_commercium(hidDevice)
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in commercium mode")) from e
                raise e
    ...
    def sign_transaction(self, tx, password):
        ...
        try:
            ...
            for utxo in inputs:
                ...
                if tx.overwintered:
                    txtmp = commerciumTransaction(bfh(utxo[0]))
                    tmp = bfh(utxo[3])[::-1]
